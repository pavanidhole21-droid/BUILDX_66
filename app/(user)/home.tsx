  ...
  return (
    <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            <View style={styles.brandRow}>
              ...
              <Text style={styles.greetingTitle}>
                Hello, <Text style={styles.userName}>Rohit 👋</Text>
              </Text>
            </View>
          ...
          <View style={styles.headerRight}>
            <TouchableOpacity
              ...
              onPress={() => alert("2 notifications: 1 request status update, 1 emergency alert.")}
            >
              <Ionicons
        ...
        {/* Primary Action Button: Find Blood */}
        <TouchableOpacity
          activeOpacity={0.88}
          onPress={handleFindBlood}
          style={styles.findBloodBtn}
        >
          <View style={styles.findBloodIconWrapper}>
            <Ionicons name="search" size={22} color="#FFFFFF" />
          </View>
          <Text style={styles.findBloodText}>Find Blood</Text>
        </TouchableOpacity>

        {/* Emergency Blood Request CTA */}
        <TouchableOpacity
          activeOpacity={0.88}
        ...
        >
          <View style={styles.emergencyLeft}>
            <View style={styles.sirenCircle}>
              <Ionicons name="warning" size={20} color={Colors.primary.DEFAULT} />
            </View>
            <View>
              <Text style={styles.emergencyTitle}>Emergency Request</Text>
              <Text style={styles.emergencySub}>
                Instant broadcast to nearby verified centers
              </Text>
            </View>
          </View>
        ...
        {/* Category Row: Hospitals, Blood Banks, NGOs */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Quick Directory</Text>
        </View>
        <View style={styles.categoryRow}>
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => handleCategoryPress("Hospitals")}
            style={styles.categoryCard}
          >
            <View style={[styles.categoryIconBg, { backgroundColor: "#E0F2FE" }]}>
              <Ionicons name="business" size={26} color="#0284C7" />
            </View>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => handleCategoryPress("Blood Banks")}
            style={styles.categoryCard}
          >
            <View style={[styles.categoryIconBg, { backgroundColor: Colors.primary.light }]}>
              <Ionicons name="water" size={26} color={Colors.primary.DEFAULT} />
            </View>
          ...
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => handleCategoryPress("NGOs")}
            style={styles.categoryCard}
          >
            <View style={[styles.categoryIconBg, { backgroundColor: "#DCFCE7" }]}>
        ...
        {/* Be a Donor Banner Card */}
        <TouchableOpacity
          activeOpacity={0.9}
          onPress={() => alert("Donor Registration: You are already registered as an active donor (O+).")}
        ...
        >
          <View style={styles.donorTextCol}>
            ...
            <Text style={styles.donorSubtitle}>
              Make a life-saving difference in Nagpur
            </Text>
          ...
          <View style={styles.donorGraphic}>
            ...
            <View style={styles.donorHeartOverlay}>
        ...
        >
          <View style={styles.requestCardTop}>
            <View>
              <Text style={styles.requestId}>#BH20250915</Text>
          ...
          <View style={styles.requestCardBottom}>
            <View style={styles.requestDetailItem}>
              ...
              <Text style={styles.detailValue}>2 units • O+</Text>
            </View>
            <View style={styles.requestDetailItem}>
